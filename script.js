...
const extra = document.getElementById("feature-extra")

modal.classList.remove("hidden")

if(type === "garage"){
title.innerText = "My Garage"
desc.innerText = "Save your Audi, track issues, and manage your vehicle history."
extra.innerHTML = `
<ul>
<li>✔ Save your model</li>
<li>✔ Track past codes</li>
<li>✔ Monitor repairs</li>
</ul>`
}

if(type === "diagnosis"){
title.innerText = "Smart Diagnosis"
desc.innerText = "Get likely causes, cost estimates, and repair difficulty instantly."
extra.innerHTML = `
<ul>
<li>✔ Ranked causes</li>
...
if(type === "community"){
title.innerText = "Community Fixes"
desc.innerText = "See real fixes shared by Audi owners."
extra.innerHTML = `
<ul>
<li>✔ Verified solutions</li>
<li>✔ Like & rank fixes</li>
<li>✔ Share your own</li>
</ul>`
}

if(type === "models"){
title.innerText = "Common Issues by Model"
desc.innerText = "Understand what problems your Audi is likely to have."
extra.innerHTML = `
<ul>
...
if(type === "updates"){
title.innerText = "Live Updates"
desc.innerText = "Stay updated with the latest fixes and trends."
extra.innerHTML = `
<ul>
<li>✔ New fixes added</li>
<li>✔ Trending problems</li>
<li>✔ Real-time updates</li>
</ul>`
}

if(type === "search"){
title.innerText = "Instant Search"
desc.innerText = "Quickly find codes, fixes, and solutions."
extra.innerHTML = `
<ul>
<li>✔ Fast results</li>
<li>✔ Smart suggestions</li>
<li>✔ Accurate matches</li>
</ul>`
}
